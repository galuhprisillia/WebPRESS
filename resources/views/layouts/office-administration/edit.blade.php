                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box white p-2 r-5">
                            ...
                            <!-- /.box-header -->
                            <div class="box-body">
                                {!! Form::model($officeadministration, ['method' => 'PATCH', 'action' => ['OfficeAdministrationController@update', $officeadministration->id]]) !!}
                                @include('layouts.office-administration.form')
                                {!! Form::close() !!}
                            </div>
                        </div>
                        <!-- /.box -->
